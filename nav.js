...
function showSelection() {
  ...
  switch (selectedValue) {
      case 'karthik':
          content = `
          <div class="mobile-inside-content">
   <h1 class="number">1</h1>
   <div class="inside-contain">
   <h1 class="inside-title">Karhtihfjdbjsbuedcbdjbvdhcuehcedhcicehc<h1>
   <p class="inside-para">lightuwhcewnceuhdedhednhddj</p>
</div>
           <a class="pdf-link" href="https://gray-deanna-22.tiiny.site" target="_blank">download</a>
